...
| Review budget | <changed lines> / 800 |
...
|-------|--------|-------------|
| Check PR Cognitive Load | ⏳ | PR should stay within 800 changed lines (`additions + deletions`) or use maintainer-applied `size:exception` |
...
- [ ] PR stays within 800 changed lines, or I have requested/obtained maintainer-applied `size:exception` with rationale documented
